  ...
  function init(){
    ...
    document.getElementById("userpara").style.color = "rgb(0, 200, 252)"
    document.getElementById("userpara").style.fontSize = "70px"; 
   // document.getElementById("userpara").style.color = "rgb(79, 79, 204)"; 
    }
